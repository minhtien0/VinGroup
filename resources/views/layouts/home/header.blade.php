<head>
  ...
  <header class="header">
    ...
    <!-- Navigation links -->
     <div>
    <div class="nav-links">
    <div style="color:#003EA1; margin-top:6px " class="UniversalFreeShipPlus__UniversalFreeShipPlusContentStyled-sc-3h4via-2 BHgRB">Cam kết</div>
      <div class="feature-item">
                <img src="https://salt.tikicdn.com/ts/upload/96/76/a3/16324a16c76ee4f507d5777608dab831.png" alt="100% hàng thật" width="20" height="20">
      ...
      <div style="display: flex; gap: 4px; padding-inline: 6px; align-items: center;"><picture class="webpimg-container"><source type="image/webp" srcset="https://salt.tikicdn.com/ts/upload/11/09/ec/456a2a8c308c2de089a34bbfef1c757b.png"><img class="WebpImg__StyledImg-sc-h3ozu8-0 fWjUGo title-img-1" src="https://salt.tikicdn.com/ts/upload/11/09/ec/456a2a8c308c2de089a34bbfef1c757b.png" alt="icon-1" width="20" height="20" srcset="https://salt.tikicdn.com/ts/upload/11/09/ec/456a2a8c308c2de089a34bbfef1c757b.png"></picture><div style="color: rgb(39, 39, 42); font-size: 12px; font-weight: 500; white-space: nowrap;">Freeship mọi đơn</div></div>
